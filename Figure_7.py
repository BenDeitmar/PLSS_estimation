...
VisualizeHSpace(Y,tau=tau,kappa=kappa,resolution=resolution,PopEV=PopEV,CurveMode=1,doCondition_2_13=True,ax=ax[0],show=False)
VisualizeHSpace(Y,tau=tau,kappa=kappa,resolution=resolution,PopEV=PopEV,CurveMode=3,doCondition_2_13=True,ax=ax[1],show=False)
