...
try:
    ...
    print("try running Fig_7_1_Preparation.R with the same choices for c and ExampleNumber first")
    print(" then running Fig_7_2_Calculations.py with the same choices for c, ExampleNumber and g_name first")
    print('#############################')
    assert 0==1
