...
try:
    ...
    for key in ToCompare:
        AvgTimes[key] = np.load(data_path+'Fig9_AvgTimes_{}_c={}_{}_Ex{}.npy'.format(key,c,data_name,ExampleNumber))
        AllErrors[key] = np.load(data_path+'Fig9_AllErrors_{}_c={}_{}_Ex{}.npy'.format(key,c,data_name,ExampleNumber))
except:
    print('#############################')
    ...
    print(" then running Figure_9_2_Calculations.py with the same choices for c, ExampleNumber and data_name first")
    print('#############################')
    assert 0==1
